<div class="bg-bab-shadow pb-4 px-4 rounded-md w-full">
    ...
    <div class="w-full flex flex-col sm:flex-row sm:justify-between gap-2  px-2 mt-2">
        ...
        <div class="w-full sm:w-64 inline-block relative ">
            <input type="text" wire:model="search" class="leading-snug border border-gray-300 block w-full appearance-none bg-gray-100 text-sm text-bab py-1 px-4 pl-8 rounded-lg" placeholder="Search" />
