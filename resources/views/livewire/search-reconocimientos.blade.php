<div class="bg-bab-shadow pb-4 px-4 rounded-md w-full">
        ...
        <table class="border-collapse w-full">
            <thead>
                <tr class="rounded-lg text-sm font-medium text-gray-700 text-left">
                    ...
                    <th class="px-4 py-2 text-left bg-gray-200 whitespace-nowrap">{{  __('messages.Title')  }}</th>
                    ...
                    <th class="px-4 py-2 text-left bg-gray-200">{{  __('messages.Color')  }}</th>
                    <th class="px-4 py-2 text-left bg-gray-200">{{  __('messages.Date Announcement')  }}</th>
                ...
                @forelse ($reconocimientos as $r)
                    <tr class=" border-b border-gray-200 py-10">
                        ...
                        <td class="px-4 py-4" width="200px">
                            @if ($r->image)
                                <img class="rounded-full block w-16 h-16" src="{{  $r->image  }}" alt="{{  $r->title  }}">
                            @else
                        ...
                        <td class="px-4 py-4 bg-reconocimientos-color">
                            {{  $r->color  }}
                        </td>
    ...
    <div>
        <x-jet-confirmation-modal wire:model="showingModal">
            ...
            <x-slot name="content">
                <p class="my-6 text-xl font-extrabold text-center">Esta seguro que quiere eliminar este Reconocimiento?</p>
            </x-slot>
            <x-slot name="footer">
