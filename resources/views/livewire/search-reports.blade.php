<div class="bg-bab-shadow pb-4 px-4 rounded-md w-full">
        ...
        <table class="border-collapse w-full">
            <thead>
                <tr class="rounded-lg text-sm font-medium text-gray-700 text-left">
                    ...
                    <th class="px-4 py-2 text-left bg-gray-200 whitespace-nowrap">{{  __('messages.Name')  }}</th>
                    <th class="px-4 py-2 text-left bg-gray-200">{{  __('messages.Image')  }}</th>
                    <th class="px-4 py-2 text-left bg-gray-200">{{  __('messages.Link spanish')  }}</th>
                    <th class="px-4 py-2 text-left bg-gray-200">{{  __('messages.Link english')  }}</th>
                    <th class="px-4 py-2 text-left bg-gray-200">{{  __('messages.Link french')  }}</th>
    ...
    <div>
        <x-jet-confirmation-modal wire:model="showingModal">
            ...
            <x-slot name="content">
                <p class="my-6 text-xl font-extrabold text-center">Esta seguro que quiere eliminar este Informe de Gestión?</p>
            </x-slot>
            <x-slot name="footer">
