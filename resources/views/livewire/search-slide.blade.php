<div class="bg-bab-shadow pb-4 px-4 rounded-md w-full">
    ...
    <div>
        <x-jet-confirmation-modal wire:model="showingModal">
            ...
            <x-slot name="content">
                <p class="my-6 text-xl font-extrabold text-center">Esta seguro que quiere eliminar este Slide?</p>
            </x-slot>
            <x-slot name="footer">
