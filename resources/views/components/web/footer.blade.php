        ...
        <div class="flex justify-around flex-col lg:flex-row">
            ...
            <div class="w-full px-2 sm:px-[15%] lg:px-4">
                ...
                <form action="" method="post">
                    ...
                    <div class="relative flex flex-wrap items-stretch w-full mb-3 max-w-lg mx-auto">
                        <span class="flex items-center py-2 px-3 text-base font-normal text-gray-500 text-center whitespace-nowrap bg-white border border-slate-200 rounded-bl rounded-tl rounded-tr-none rounded-br-none">@</span>
            ...
            <div class="w-full px-2 sm:px-[15%] lg:px-4">
                ...
                <ul class="text-slate-50 mb-2">
                    ...
                    <li class="my-4">
                        <a href="#" class="text-slate-50 hover:text-slate-500 underline hover:no-underline">Política de tratamiento de datos</a>
                    </li>
                </ul>
                <ul class="my-4 text-slate-50 flex justify-around w-full">
                    <li>
                        <a href="https://es-la.facebook.com/Bancodealimentosbogota/" target="_blank" class="block" rel="noopener"> 
                    ...
                    <li>
                        <a href="https://www.instagram.com/bancodealimentosbgt/" target="_blank" class="block" rel="noopener"> 
                            <i class="fa-brands fa-instagram text-2xl text-slate-50 hover:text-slate-200"></i>
                        </a>
                    </li>
                    <li>
                        <a href="https://www.linkedin.com/company/banco-de-alimentos-de-bogot%C3%A1" target="_blank" class="block" rel="noopener"> 
