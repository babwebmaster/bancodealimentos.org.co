<x-app-layout>
    ...
    {{ Breadcrumbs::render('reconocimientos.create', $reconocimientos) }}
    <div class="mb-5">
        <div 
        ...
        >
            <form action="{{  route('reconocimientos.store')  }}" class="px-4 py-4 w-full bg-bab-shadow rounded-md" method="POST" enctype="multipart/form-data">
                @csrf
                <h3 class="text-center text-2xl font-bold my-8">{{  __('messages.Create Announcement')  }}</h3>
                <div class="block sm:flex sm:gap-10">
                    <div class="sm:basis-1/2">
                        <div class="mb-5">
                            ...
                            <input type="text" name="title" id="title" placeholder="{{  __('messages.Announcement Title')  }}" value="{{  old("title", $reconocimientos->title)  }}"
                        ...
                        <div class="mb-5">
                            ...
                            <textarea name="content" id="content" placeholder="{{  __('messages.Announcement Content')  }}" value=""
                                class="w-full rounded-md border border-[#000] bg-transparent text-bab py-3 px-6 text-base text-left font-medium text-bab outline-none focus:border-[#6A64F1] focus:shadow-md">{{  old("content", $reconocimientos->content)  }}</textarea>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="date" name="date_announcement" id="date" value="{{  old("date", $reconocimientos->date_announcement)  }}"
                    ...
                    <div class="sm:basis-1/2">
                        <div class="mb-5">
                            ...
                            <img src="{{  $reconocimientos->image  }}" class="h-20 hidden mb-5" id="preview" alt="{{  $reconocimientos->title  }}">
                        ...
                        <div class="mb-5">
                            ...
                            <x-web.drop-icons :reconocimiento="$reconocimientos"></x-web.drop-icons>
                        ...
                        <div class="mb-5">
                            ...
                            <input 
                                ...
                                name="color" 
                                id="color" 
                                placeholder="{{  __('messages.Color Icon')  }}" 
                                value="{{  old("color", $reconocimientos->color)  }}"
                ...
                <div class="w-full flex justify-center px-2 mt-2">
                    <button type="submit" class="inline-flex items-center justify-end px-4 py-2 bg-bab border border-transparent rounded-md font-semibold text-md text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">
                        {{  __('messages.Create Announcement')  }}
                    </button>
                </div>
            </form>
        </div>
